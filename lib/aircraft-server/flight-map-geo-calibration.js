...
export function computeGeoCalibrationFromSpots(spots, northDirection, baseGeo = {}) {
    ...
    const geo = {
        ...
        ...(finiteNum(src.overlayCenterLat) != null
            ? { overlayCenterLat: finiteNum(src.overlayCenterLat) }
            : {}),
        ...(finiteNum(src.overlayCenterLng) != null
            ? { overlayCenterLng: finiteNum(src.overlayCenterLng) }
            : {}),
        ...(finiteNum(src.overlayZoom) != null ? { overlayZoom: finiteNum(src.overlayZoom) } : {}),
        ...(finiteNum(src.overlayHeading) != null
            ? { overlayHeading: finiteNum(src.overlayHeading) }
            : {}),
    };
