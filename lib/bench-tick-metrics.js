 ...
 * @returns {{ minTickPerSec: number, byRoom: Record<string, number>, debug: object, diagnosis?: string }}
 */
export function getTickMetricsSnapshot() {
    ...
    const snap = {
        ...
        byRoom,
        debug,
        diagnosis: minTickPerSec <= 0 ? diagnoseTickMetrics(debug, byRoom) : undefined,
    };
