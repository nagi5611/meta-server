...
function fillWorldAircraftPhysicsForm(world) {
    ...
    const ids = [
        ...
        ['world-aircraft-pitch-up-max-ground-deg', m.pitchUpMaxGroundDeg],
        ['world-aircraft-pitch-up-max-air-deg', m.pitchUpMaxAirDeg],
...
function readWorldAircraftPhysicsFromForm() {
    ...
    const raw = {
        ...
        pitchUpMaxGroundDeg: parse('world-aircraft-pitch-up-max-ground-deg', DEFAULT_AIRCRAFT_PHYSICS.pitchUpMaxGroundDeg),
        pitchUpMaxAirDeg: parse('world-aircraft-pitch-up-max-air-deg', DEFAULT_AIRCRAFT_PHYSICS.pitchUpMaxAirDeg),
...
function bindEvents() {
    ...
    for (const aircraftInputId of [
        ...
        'world-aircraft-pitch-up-max-ground-deg',
        'world-aircraft-pitch-up-max-air-deg',
