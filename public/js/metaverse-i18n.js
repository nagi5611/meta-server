...
export const METAVERSE_STRINGS = {
    ...
    'info.serverMaintenanceDefault': {
        ja: '現在メンテナンス中です。接続が不安定になったり\n一部の機能で不具合が発生する可能性があります。',
        en: 'Maintenance in progress. Your connection may become unstable,\nand some features may not work correctly.',
        zh: '正在维护中。连接可能不稳定，\n部分功能可能出现异常。',
    },
    ...
    'menu.captionsTitle': { ja: '字幕 ON/OFF', en: 'Captions on/off', zh: '字幕开关' },
    'menu.captionsOn': { ja: '字幕: ON', en: 'Captions: on', zh: '字幕：开' },
    'menu.captionsOff': { ja: '字幕: OFF', en: 'Captions: off', zh: '字幕：关' },
    ...
    'vrMenu.admin': { ja: '管理', en: 'Admin', zh: '管理' },
    'vrMenu.mic': { ja: 'Mic', en: 'Mic', zh: '麦克风' },
    'vrMenu.speaker': { ja: 'Spk', en: 'Spk', zh: '扬声器' },
    'vrMenu.chat': { ja: 'チャット', en: 'Chat', zh: '聊天' },
    'vrMenu.stamp': { ja: 'スタンプ', en: 'Stamp', zh: '表情' },
    'vrMenu.help': { ja: 'ヘルプ', en: 'Help', zh: '帮助' },
    'vrMenu.restart': { ja: '再開', en: 'Restart', zh: '重启' },
    'vrMenu.settings': { ja: '設定', en: 'Settings', zh: '设置' },
    'vrMenu.logout': { ja: '退出', en: 'Exit', zh: '退出' },
    'vrMenu.chatTapInput': { ja: 'タップして入力', en: 'Tap to type', zh: '点击输入' },
    'vrMenu.chatSend': { ja: '送信', en: 'Send', zh: '发送' },
    'vrMenu.chatEmpty': { ja: 'メッセージはありません', en: 'No messages yet', zh: '暂无消息' },
    'vrMenu.chatYou': { ja: '自分', en: 'You', zh: '我' },
    'vrMenu.notAvailableInVr': {
        ja: 'VR では利用できません',
        en: 'Not available in VR',
        zh: 'VR 中不可用',
    },
    'vrMenu.cycleMic': { ja: 'マイクを切替', en: 'Cycle mic', zh: '切换麦克风' },
    'vrMenu.cycleSpeaker': { ja: 'スピーカーを切替', en: 'Cycle speaker', zh: '切换扬声器' },
    'vrMenu.viewModeVrNote': {
        ja: 'VR 中は一人称固定のため変更できません',
        en: 'First-person only in VR',
        zh: 'VR 中仅第一人称',
    },
    'vrMenu.graphicsVrNote': {
        ja: 'VR 中は品質が自動で低くなります',
        en: 'Quality is auto-low in VR',
        zh: 'VR 中画质自动降低',
    },
    'vrMenu.pixelRatioVrNote': {
        ja: 'VR 中は最大 1 に制限されます',
        en: 'Capped at 1 in VR',
        zh: 'VR 中最高为 1',
    },
    'vrMenu.proModeVrNote': {
        ja: 'VR 中はプロモードの効果が限定的です',
        en: 'Pro mode has limited effect in VR',
        zh: 'VR 中专业模式效果有限',
    },
    'vrMenu.cycleGraphics': { ja: '品質を切替', en: 'Cycle quality', zh: '切换画质' },
    'vrMenu.adminLinkNote': {
        ja: '管理画面は VR 外で開いてください',
        en: 'Open admin panel outside VR',
        zh: '请在 VR 外打开管理后台',
    },
    'vrMenu.restartBody': {
        ja: '現在のワールドの初期地点へ戻りますか？',
        en: 'Return to this world spawn?',
        zh: '返回本世界出生点？',
    },
    ...
    'ui.aircraftAutopilotOn': { ja: 'AP - ON', en: 'AP - ON', zh: 'AP - ON' },
    'ui.aircraftAutopilotOff': { ja: 'AP - OFF', en: 'AP - OFF', zh: 'AP - OFF' },
