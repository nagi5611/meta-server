...
export const METAVERSE_STRINGS = {
    ...
    'ui.aircraftHudLinesHtml': {
        ja: '<span class="aircraft-hud-line">速度 <strong id="aircraft-hud-speed">0</strong> km/h　姿勢 P <strong id="aircraft-hud-pitch">0</strong>° R <strong id="aircraft-hud-roll">0</strong>° Y <strong id="aircraft-hud-yaw">0</strong>°</span><span class="aircraft-hud-line">角速度 ヨー <strong id="aircraft-hud-omegay">0</strong>　ピッチ <strong id="aircraft-hud-omegap">0</strong>　ロール <strong id="aircraft-hud-omegar">0</strong> rad/s　<strong id="aircraft-hud-ground">—</strong></span><span class="aircraft-hud-line">スロットル <strong id="aircraft-hud-throttle">0</strong>%　エンジン <strong id="aircraft-hud-enginerpm">0</strong> RPM　フラップ <strong id="aircraft-hud-flap">UP</strong>　Vfe <strong id="aircraft-hud-vfe">—</strong> m/s <strong id="aircraft-hud-vfewarn"></strong></span>',
        en: '<span class="aircraft-hud-line">Speed <strong id="aircraft-hud-speed">0</strong> km/h　Att. P <strong id="aircraft-hud-pitch">0</strong>° R <strong id="aircraft-hud-roll">0</strong>° Y <strong id="aircraft-hud-yaw">0</strong>°</span><span class="aircraft-hud-line">Rates Yaw <strong id="aircraft-hud-omegay">0</strong>　Pitch <strong id="aircraft-hud-omegap">0</strong>　Roll <strong id="aircraft-hud-omegar">0</strong> rad/s　<strong id="aircraft-hud-ground">—</strong></span><span class="aircraft-hud-line">Throttle <strong id="aircraft-hud-throttle">0</strong>%　Engine <strong id="aircraft-hud-enginerpm">0</strong> RPM　Flaps <strong id="aircraft-hud-flap">UP</strong>　Vfe <strong id="aircraft-hud-vfe">—</strong> m/s <strong id="aircraft-hud-vfewarn"></strong></span>',
        zh: '<span class="aircraft-hud-line">速度 <strong id="aircraft-hud-speed">0</strong> km/h　姿态 P <strong id="aircraft-hud-pitch">0</strong>° R <strong id="aircraft-hud-roll">0</strong>° Y <strong id="aircraft-hud-yaw">0</strong>°</span><span class="aircraft-hud-line">角速度 偏航 <strong id="aircraft-hud-omegay">0</strong>　俯仰 <strong id="aircraft-hud-omegap">0</strong>　横滚 <strong id="aircraft-hud-omegar">0</strong> rad/s　<strong id="aircraft-hud-ground">—</strong></span><span class="aircraft-hud-line">油门 <strong id="aircraft-hud-throttle">0</strong>%　发动机 <strong id="aircraft-hud-enginerpm">0</strong> RPM　襟翼 <strong id="aircraft-hud-flap">UP</strong>　Vfe <strong id="aircraft-hud-vfe">—</strong> m/s <strong id="aircraft-hud-vfewarn"></strong></span>',
    },
