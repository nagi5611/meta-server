...
export const METAVERSE_STRINGS = {
    ...
    'ui.aircraftHudLinesHtml': {
        ja: '<span class="aircraft-hud-line">速度 <strong id="aircraft-hud-speed">0</strong> m/s　姿勢 P <strong id="aircraft-hud-pitch">0</strong>° R <strong id="aircraft-hud-roll">0</strong>° Y <strong id="aircraft-hud-yaw">0</strong>°</span><span class="aircraft-hud-line">角速度 ヨー <strong id="aircraft-hud-omegay">0</strong>　ピッチ <strong id="aircraft-hud-omegap">0</strong>　ロール <strong id="aircraft-hud-omegar">0</strong> rad/s　<strong id="aircraft-hud-ground">—</strong></span>',
        en: '<span class="aircraft-hud-line">Speed <strong id="aircraft-hud-speed">0</strong> m/s　Att. P <strong id="aircraft-hud-pitch">0</strong>° R <strong id="aircraft-hud-roll">0</strong>° Y <strong id="aircraft-hud-yaw">0</strong>°</span><span class="aircraft-hud-line">Rates Yaw <strong id="aircraft-hud-omegay">0</strong>　Pitch <strong id="aircraft-hud-omegap">0</strong>　Roll <strong id="aircraft-hud-omegar">0</strong> rad/s　<strong id="aircraft-hud-ground">—</strong></span>',
        zh: '<span class="aircraft-hud-line">速度 <strong id="aircraft-hud-speed">0</strong> m/s　姿态 P <strong id="aircraft-hud-pitch">0</strong>° R <strong id="aircraft-hud-roll">0</strong>° Y <strong id="aircraft-hud-yaw">0</strong>°</span><span class="aircraft-hud-line">角速度 偏航 <strong id="aircraft-hud-omegay">0</strong>　俯仰 <strong id="aircraft-hud-omegap">0</strong>　横滚 <strong id="aircraft-hud-omegar">0</strong> rad/s　<strong id="aircraft-hud-ground">—</strong></span>',
    },
