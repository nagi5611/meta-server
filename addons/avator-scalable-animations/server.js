...
import {
    parseAvatorScalableBindings,
    enrichBindingsWithSlotKeys,
} from '../../lib/avator-scalable-bindings.js';
...
export default {
     ...
     */
    async register(ctx) {
        const bindings = enrichBindingsWithSlotKeys(parseAvatorScalableBindings(ctx.config.bindings));
